 ...
 * {@link IndiFixtureFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link IndiFixtureFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class IndiFixtureFragment extends Fragment {
     ...
     * @return A new instance of fragment IndiFixtureFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static IndiFixtureFragment newInstance(String param1, String param2) {
        IndiFixtureFragment fragment = new IndiFixtureFragment();
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try {
                    ...
                    for(int i=0;i<teams.length();i+=1)
                    {
                        ...
                        if(t.getString("short_name").equals(mParam1)){
                            //System.out.println("came1");
                            team1 = t;
                        }
                        if(t.getString("short_name").equals(mParam2)){
                    ...
                    for(int i =0;i<elements.length();i+=1){
                        ...
                        if((e.getString("team")== team1.getString("id") || e.getString("team")==team2.getString("id")) && e.getString("news").length()==0)
                        {
