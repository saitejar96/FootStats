...
public class GridActivity3 extends ArrayAdapter {
    private Context context;
    private int layoutResourceId;
    private ArrayList data = new ArrayList();

    public GridActivity3(Context context, int layoutResourceId, ArrayList data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        BestPlayerX item = (BestPlayerX) data.get(position);
